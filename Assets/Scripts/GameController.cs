...
public class GameController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        carbonCredit += 0.1 * Actions.Tree.trees / tickRate; // Ganho por �rvores
        carbonCredit -= 0.3 * Actions.Thermal.factories / tickRate; // Perda por termel�tricas
        carbonCredit -= 0.1 * Actions.Solar.panels / tickRate; // Perda por paineis de energia solar
        carbonCredit -= 0.025 * Actions.Wind.turbines / tickRate; // Perda por energia e�lica
    ...
    void Update()
    {
        ...
        //displayMonth.text = string.Format("M�s: {0}", month);
